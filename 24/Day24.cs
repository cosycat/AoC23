...
public static partial class Day24 {
    private const string InputFileName = "inputDay24.txt";
    ...
    public static void Main(string[] args) {
        ...
        Stopwatch sw = new();
        sw.Start();
        Solve(InputFileName, out var result1, out var result2, false);
        sw.Stop();
    ...
    private static void TestRun() {
        ...
        foreach (var (testFileName, expectedResultTest1, expectedResultTest2) in Tests) {
            ...
            Solve(testFileName, out var resultTest1, out var resultTest2, isTest: true);
